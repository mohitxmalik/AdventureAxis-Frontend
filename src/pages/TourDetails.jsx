                  ...
                  <div className="weather__updates mt-4">
                    ...
                    <div className="weather">
                      <div className="weather-info">
                        <div className="weather-key">Place</div>
                        <div className="weather-value">{weatherData?.name}</div>
                      </div>
                      <div className="weather-info">
                        <div className="weather-key">Temperature</div>
                        <div className="weather-value">
                          {(weatherData?.main?.temp - 273.15).toFixed(2)} °C
                        </div>
                      </div>
                      <div className="weather-info">
                        <div className="weather-key">Weather</div>
                        <div className="weather-value">
                      ...
                      <div className="weather-info">
                        <div className="weather-key">Wind Speed</div>
                        <div className="weather-value">
                          {weatherData?.wind?.speed} km/h
                        </div>
                      </div>
                      {/* <div className="weather-info">
                        <div className="weather-key">Wind Angle</div>
                        <div className="weather-value">
